package br.com.vestcasa.config;
...
import br.com.vestcasa.serialization.converter.YamlJackson2HttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		/*
		 * via QUERY PARAM ?mediaType=xml ou json configurer.favorParameter(true)
